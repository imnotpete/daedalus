...
const char * const	LOGO_FILENAME {DAEDALUS_POSIX_PATH( "Resources/logo.png" )};
...
const char * const		gPreviewDirectory = DAEDALUS_POSIX_PATH( "Resources/Preview/" );
